...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-5 border-t border-border bg-background/94 px-2 py-2 backdrop-blur md:left-1/2 md:max-w-xl md:-translate-x-1/2 md:rounded-t-lg md:border-x">
        {nav.map((item) => {
