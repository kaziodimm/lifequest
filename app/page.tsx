  ...
  return (
    <AppShell>
      ...
      <section className="mt-5 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <Card>
          <CardHeader><CardTitle className="flex items-center gap-2"><GitBranch size={17} className="text-primary" />Current Strategy</CardTitle></CardHeader>
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>1. Complete one mission that moves a technology forward.</p>
            <p>2. Unlock an available node in the Life Tree.</p>
            <p>3. Protect the streak by doing the smallest meaningful step.</p>
          </CardContent>
        </Card>
      </section>
    </AppShell>
