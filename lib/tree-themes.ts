...
export const treeThemes: TreeTheme[] = [
  {
    ...
    unlock: { defaultUnlocked: true, previewable: true },
  ...
  },
  {
    ...
    unlock: { defaultUnlocked: false, previewable: true, rewardSource: "Complete The Awakening Trial" },
  ...
  },
  {
    ...
    unlock: { defaultUnlocked: false, previewable: true, rewardSource: "Future chapter Trial reward" },
